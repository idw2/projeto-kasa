<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <ul class="nav navbar-nav side-nav">
            <li>
                <?php echo $this->Html->link(__('<i class="fa fa-fw fa-user"></i> List Agents'), array('controller' => 'agents', 'action' => 'index'), array('escape' => false)); ?>
            </li>
            <li>
                <?php echo $this->Html->link(__('<i class="fa fa-fw fa-th-large"></i> List Banners'), array('controller' => 'banners', 'action' => 'index'), array('escape' => false)); ?>
            </li>
            <li>
